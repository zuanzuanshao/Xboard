...
Xboard is a Laravel-based proxy panel system for managing various protocol servers (v2ray, shadowsocks, trojan, etc.). It features a modern tech stack with Laravel 11 + Octane backend, React admin panel, and Vue3 user frontend.
...
### Backend Structure
- **Laravel 11 + Octane**: High-performance PHP framework with Swoole/RoadRunner
...
- `library/`: Custom libraries and utilities
